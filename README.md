...
You can choose to place the breadcrumbs at the Top or Bottom of the editor window.      
Once enabled, the path to the current JSON element under your cursor will be displayed in the breadcrumb navigation bar.       
